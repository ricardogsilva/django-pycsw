...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djangopycsw', '0013_auto_20150710_1207'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.TextField(help_text=b'Maps to pycsw:AccessConstraints', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='record',
            name='condition_applying_to_access_and_use',
            field=models.TextField(help_text=b'Maps to pycsw:ConditionApplyingToAccessAndUse', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='record',
            name='coupling_type',
        ...
        migrations.AlterField(
            model_name='record',
            name='distance_uom',
            field=models.CharField(help_text=b'Maps to pycsw:DistanceUOM', max_length=200, null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='record',
            name='distance_value',
        ...
        migrations.AlterField(
            model_name='record',
            name='lineage',
            field=models.TextField(help_text=b'Maps to pycsw:Lineage', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='record',
            name='operation',
        ...
        migrations.AlterField(
            ...
            field=models.TextField(help_text=b'Maps to pycsw:OtherConstraints', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='record',
