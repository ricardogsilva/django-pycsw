...
class Record(models.Model):
    ...
    abstract = models.TextField(blank=True, help_text='Maps to pycsw:Abstract')
    ...
    keywords_types = models.CharField(max_length=255, blank=True,
                                      help_text='Maps to pycsw:Keywordstype')

    format = models.CharField(max_length=50, help_text="Maps to pycsw:Format")
    ...
    type = models.CharField(max_length=50, help_text='Maps to pycsw:Type')
    bounding_box = models.TextField(help_text='Maps to pycsw:BoundingBox')
    crs = models.CharField(max_length=255, help_text='Maps to pycsw:CRS')
    alternate_title = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:AlternateTitle')
    organization_name = models.CharField(
        max_length=255, help_text='Maps to pycsw:OrganizationName')
    security_constraints = models.CharField(
        max_length=255, help_text='Maps to pycsw:SecurityConstraints')
    parent_identifier = models.CharField(
        max_length=255, help_text='Maps to pycsw:ParentIdentifier')
    topic_category = models.CharField(
        max_length=255, help_text='Maps to pycsw:TopicCategory')
    resource_language = models.CharField(
        max_length=30, help_text='Maps to pycsw:ResourceLanguage')
    geographic_description_code = models.CharField(
        max_length=50, help_text='Maps to pycsw:GeographicDescriptionCode')
    denominator = models.CharField(
        max_length=255, help_text='Maps to pycsw:Denominator')
    distance_value = models.CharField(
        max_length=50, help_text='Maps to pycsw:DistanceValue')
    distance_uom = models.CharField(
        max_length=30, help_text='Maps to pycsw:DistanceUOM')
    ...
    service_type = models.CharField(
        max_length=30, blank=True, help_text='Maps to pycsw:ServiceType')
    service_type_version = models.CharField(
        max_length=30, blank=True,
        help_text='Maps to pycsw:ServiceTypeVersion'
    )
    operation = models.CharField(
        max_length=30, blank=True, help_text='Maps to pycsw:Operation')
    coupling_type = models.CharField(
        max_length=30, blank=True, help_text='Maps to pycsw:CouplingType')
    operates_on = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:OperatesOn')
    ...
    operates_on_name = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:OperatesOnName')
    degree = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Degree')
    access_constraints = models.CharField(
        max_length=255, blank=True,
        help_text='Maps to pycsw:AccessConstraints'
    )
    other_constraints = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:OtherConstraints')
    classification = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Classification')
    ...
    lineage = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Lineage')
    ...
    creator = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Creator')
    publisher = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Publisher')
    contributor = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Contributor')
    relation = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Relation')
    links = models.CharField(
        max_length=255, blank=True, help_text='Maps to pycsw:Links')
